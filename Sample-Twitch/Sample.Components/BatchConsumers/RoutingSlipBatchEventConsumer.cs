 namespace Sample.Components.BatchConsumers
{
    ...
    public class RoutingSlipBatchEventConsumer(ILogger<RoutingSlipBatchEventConsumer> logger) :
        IConsumer<Batch<RoutingSlipCompleted>>
    {
        private readonly ILogger<RoutingSlipBatchEventConsumer> _logger = logger;
