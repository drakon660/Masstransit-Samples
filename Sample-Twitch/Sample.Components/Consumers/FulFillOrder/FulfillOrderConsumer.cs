namespace Sample.Components.Consumers
{
    ...
    public class FulfillOrderConsumer(ILogger<FulfillOrderConsumer> logger) :
        IConsumer<FulfillOrder>
    {
        private readonly ILogger<FulfillOrderConsumer> _logger = logger;
        ...
        public async Task Consume(ConsumeContext<FulfillOrder> context)
        {
            ...
            _logger.LogInformation("[FulfillOrderConsumer]");
